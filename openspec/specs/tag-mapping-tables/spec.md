# tag-mapping-tables Specification

## Purpose
Static mapping tables derived from taxonomy for cross-category inference and candidate reduction. Includes Library→Domain mappings and (Language, Domain)→Concept candidate reductions.
