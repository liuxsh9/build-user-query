...
## Purpose
Pipeline for constructing high-quality labeled golden sets by splitting annotation into per-category small tasks for LLM, with multi-model verification to ensure annotation quality.
