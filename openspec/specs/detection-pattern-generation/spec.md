# detection-pattern-generation Specification

## Purpose
LLM-driven pipeline to generate detection patterns for all 672 taxonomy tags. Produces category-specific patterns (import patterns for Library, keyword dictionaries for Concept, etc.) and validates them for consistency with taxonomy metadata.
